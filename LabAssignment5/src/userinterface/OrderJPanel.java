...
public class OrderJPanel extends javax.swing.JPanel {
    ...
    private ArrayList<OrderMenu> cartList;
    private double totalPrice;
    
    public OrderJPanel(JPanel userProcessContainer, EcoSystem ecosystem, UserAccount userAccount, Restaurant restaurant) {
        initComponents();
        ...
        cartList = new ArrayList<OrderMenu>();
    ...
    private void btnAddToCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToCartActionPerformed
        ...
        if(selectedRow >= 0) {
            OrderMenu selectedDish = (OrderMenu) tblCustMenu.getValueAt(selectedRow, 0);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if(selectedRow >= 0) {
            OrderMenu selectedDish = (OrderMenu) tblCart.getValueAt(selectedRow, 0);
